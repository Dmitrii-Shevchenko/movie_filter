...
describe Theatre do
  ...
  describe '#show' do
    ...
    context 'day' do
      let(:time) { '18:00' }
      it { is_expected.to eq('Psycho - классический фильм, режиссёр Alfred Hitchcock (Psycho,Rear Window,North by Northwest,Vertigo,Rebecca,Dial M for Murder,Strangers on a Train,Notorious)')}            
    end
